...
public class ReviewPersistenceStub implements ReviewPersistence {
    ...
    public ReviewPersistenceStub() {
        ...
        courseReviews.add(new CourseReview(c1, "It was good", 5.0f, 3.0f));
        courseReviews.add(new CourseReview(c1, "It was not good at all", 1.0f, 5.0f));
        courseReviews.add(new CourseReview(c2, "It was medium", 3.0f, 4.0f));

        // ADD INSTRUCTOR REVIEWS
        Instructor i1 = new Instructor("Dr.", "John", "Smith");
        Instructor i2 = new Instructor("Professor", "Nancy", "Rogers");
        instructorReviews.add(new InstructorReview(i1, "Good Prof", 4.0f, 3.0f));
        instructorReviews.add(new InstructorReview(i2, "AMAZING PROFESSORRRRR", 5.0f, 2.0f));
    }
    @Override
